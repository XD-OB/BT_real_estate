...
def contact(request):
    if request.method == 'POST':
        ...
        # Send email:
        send_mail(
            'New Inquiry disposed!',
            request.user.first_name + ' ' + request.user.last_name + ' have made an inquiry, in order to get response about the propriety: ' + listing + '.',
            'oussbelch96@gmail.com',
            [
                'oussbelch96@gmail.com',
                realtor_email
            ],
